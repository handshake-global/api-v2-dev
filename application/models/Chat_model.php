	...
	public function getMessageList($data=[]){
		if(empty($data))
			...
			foreach ($finalConnection as $final) {
				if($final['s1']==1 || $final['s1']==3 || $final['s2']==1 || $final['s2']==3)
